...
public class FicheroBinario {
    ...
    public static void testEscribirFicheroBinaro() {

        ObjectOutputStream f = null;
        File fichero = null;

        Empleado e1 = new Empleado("Juan", "Antonio", 23, 600);
        Empleado e2 = new Empleado("Carmen", "NetBeans", 40, 400);
    ...
    public static void testLeerFicheroBinaro(){
